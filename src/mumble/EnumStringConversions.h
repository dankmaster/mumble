...
const char *enumToString(Settings::SpeechCleanupBackend e);
const char *enumToString(Settings::RemoteSpeechCleanupPreset e);
...
const char *enumToString(Settings::ModernLayoutPolicy e);
...
void stringToEnum(const std::string &str, Settings::SpeechCleanupBackend &e);
void stringToEnum(const std::string &str, Settings::RemoteSpeechCleanupPreset &e);
...
void stringToEnum(const std::string &str, Settings::ModernLayoutPolicy &e);
